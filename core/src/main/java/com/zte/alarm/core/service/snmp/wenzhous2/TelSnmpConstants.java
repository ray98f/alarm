...
public enum TelSnmpConstants {
    ...
    TelSnmpConstants(String name, String oid) {
        this.name = name;
        this.oid = oid;
    }

    TelSnmpConstants(String name, String oid, String lowerBound, String upperBound) {
        this.name = name;
        this.oid = oid;
    ...
    public static TelSnmpConstants from(String oid) {
        for (TelSnmpConstants telSnmpConstants : TelSnmpConstants.values()) {
